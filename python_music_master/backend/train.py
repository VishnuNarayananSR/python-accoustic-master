...
def create_model(num_classes, sr=16000, t=1):
    ...
    model = tf.keras.models.Sequential([
                                ...
                                tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(32, 3, activation='tanh')),
                                ...
                                tf.keras.layers.ZeroPadding2D(padding=(1,1)),
                                tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(256, 3, activation='relu')),
                                tf.keras.layers.ZeroPadding2D(padding=(1,1)),
                                tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(256, 3, activation='relu')),
